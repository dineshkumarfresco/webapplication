...
<body>
	...
	<div class="head0">
		<a href="tproduct.php" id="trhome"><p id="home"><
		</p></a>
	</div>
	...
	<div class="mmmlogo">
	 ...
	 <div class="cards">
	<a href="signinfnvm.php"> <div class="cartimg" id="ci">
        	<p id="cartname">வெளியேறு</p>
        </div></a>
	...
	<div class="cont">
		...
		<table class='producttable'>
			...
			if(!empty($_SESSION["CARTS"]))
			{
               ...
               $qqq=$values["QTY"];
					...
					<td><a href='tAddtocart.php?del={$values["pid"]}'>X</a></td>
					";
		...
		<div class="totaltable">
			...
			$countt=count($pid);
			echo "
			      <p><u>விலைப்பட்டியல்</u></p><br>
			      <p>பொருள் (எண்ணிக்கை)<span>: {$countt}</span></p><br>
			      <p>கூட்டுத்தொகை <span>: ₹{$total}</span></p><br>
			      <p>விநியோக கட்டணம் <span>: ₹{$DC}</span></p><br>
			      <p id='ttt'>பெரும் மொத்தம்<span>: ₹{$grandtotal}</span></p>
			      ";
			?></div>
         <div class="tt2">
		 <button id="order"><?php echo " <a href='tpayment.php? gt={$grandtotal} & opn={$ppp} & opq={$qqq}' >வாங்குவதற்குத் தொடர்க</a> ";?></button>
