  ...
  if(isset($_SESSION["CARTS"]))
	{
      ...
      $index=count($_SESSION["CARTS"]);
	  	$item=array(
		   ...
		   header("Location:tAddtocart.php");
		  	  }
	  else
	  {
