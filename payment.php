...
<body>
	...
	<div class="con">
		<div class="address">
			<p id="addresstitle">Delivery Info</p><br>  
			<form method='POST'>
            ...
            <div class="cash">
	        <input type="submit" name="reg" id="bb1" value="CASHON DELIVERY">
	         </div>
	     </form>
		</div>
...
$sql="INSERT INTO deliveryinfo(ORDERID,USERNAME,NAME,MOBILENUMBER,ADDRESS,DISTRICT,STATE,ODATE,OTIME,OPNAME,OPQTY,OPRATE,TRATE,GRANDTOTAL) VALUES ('{$COD}','{$_SESSION['USERNAME']}','{$NAME}','{$NUMBER}','{$ADDRESS}','{$DISTRICT}','{$STATE}','{$dt}','{$tme}','{$values["PNAME"]}','{$values["QTY"]}','{$values["PRATE"]}','{$amt}','{$_GET['gt']}')";
