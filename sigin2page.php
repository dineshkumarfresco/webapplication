...
<p id="x"><a href="fnvmmainpage.php"><</a></p>
        ...
        <p id="b2para">_____________New to FRESCO?______________</p>
        <button name="newsignin" id="b2"><a href="regfnvm.php">Create your Fresco Account</a></button><br><br>
      <p id="alert"></p>
        </div>
...
if(isset($_POST['signin']))
{
    ...
    $sql="SELECT * FROM logindata WHERE EMAILID='$EMAILID' && PASSWORD='$PASSWORD'";
...
if ($num == 0){
     echo "<script>document.getElementById('alert').innerHTML='You have not yet registred !!!';</script>";
