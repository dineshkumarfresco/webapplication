...
$sql="SELECT d.*,di.* FROM deliveryinfo d,deliveryaddinfo di WHERE d.ORDERID = di.DORDERID && ODATE between '$fromdate' AND '$todate'";

$retval=mysqli_query($con,$sql);
$stotal=mysqli_num_rows($retval);
}
...
<div class="links">
 ...
 <div class="contents" id="contents">
    ...
    <div class="user">
        <p id="ptotal">Featched Records: <?php echo "$stotal";?></p>
        <img src="../user.png" id="userimg">
        <p id="username"><?php echo " ".$_SESSION['AUSERNAME'];?></p> 
    </div>
  <div class="data">
<form method="POST" id="form">
	 <input type="text" name="fd" placeholder="00/00/0000"> To 
	 <input type="text" name="td" placeholder="00/00/0000">
